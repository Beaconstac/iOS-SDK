...
/**
 * Designated initalizer for the class.
 */
- (id)initWithName:(NSString*)name
           mediaId:(NSNumber*)mediaID
               url:(NSURL*)mediaUrl
      organization:(NSNumber*)organizationId
              type:(NSString*)contentType
           created:(NSDate*)createdAt
          modified:(NSDate*)modifiedAt
            expiry:(NSDate*)expiryAt;

/**
 * Convenience initalizer using the json returned from /media.
 */
+ (MSMedia*)mediaWith:(NSDictionary*)mediaJson;
